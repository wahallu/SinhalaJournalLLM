...
RULES: dict[str, RuleDefinition] = {
    ...
    for rule in (
        ...
        _rule("ENTITY_PROTECT_001", "Named-entity protection", "safety", RuleTier.PROTECT, Severity.ERROR, "Block unapproved probable-name substitutions."),
        ...
        _rule("QUOTE_PROTECT_001", "Quotation protection", "safety", RuleTier.PROTECT, Severity.WARNING, "Keep model rewrites inside direct quotations advisory."),
        ...
        _rule("AMBIG_KEEP_001", "Protected valid pair", "ambiguity", RuleTier.NEURAL, Severity.WARNING, "Do not globally replace context-dependent valid Sinhala forms."),
        ...
        _rule("SEMANTIC_ENTITY_001", "Semantic entity", "safety", RuleTier.PROTECT, Severity.ERROR, "Detect factual entity mutation at edit level."),
