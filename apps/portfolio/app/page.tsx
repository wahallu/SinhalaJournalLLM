  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FAF9F5] text-[#1B1B1B]">
      ...
      <main className="flex-1">
        ...
        {/* 3. Manifesto Section with Celestial Geometric Vector Rings */}
        <Manifesto />

        {/* 4. Sinhala Journal LLM Foundation Model & Enterprise Architecture Deep Dive */}
        <ResearchShowcase />

        {/* 5. Floating Visual AI Collage (Sinhala Linguistic Intelligence) */}
        <VisualCollage />
