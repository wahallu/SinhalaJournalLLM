...
The Google Docs Add-on connects directly to the production SinAI backend service (`https://backend.sin-ai.app/api/v1`) by default. The connection status indicator in the sidebar header automatically reflects the live status.
