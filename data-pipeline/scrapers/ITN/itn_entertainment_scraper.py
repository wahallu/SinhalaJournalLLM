...
CATEGORY_URL = "https://www.itnnews.lk/entertainment/"

OUTPUT_DIR    = "output"
OUTPUT_FILE   = "itn_entertainment.jsonl"
PROGRESS_FILE = "itn_entertainment_progress.json"
...
async def main():
    ...
    try:
        ...
        while True:
            ...
            for idx, article_url in enumerate(article_links, 1):
                ...
                article_data = {
                    ...
                    "News Content": content, "URL": article_url,
        ...
        await kill_crawler(crawler_holder[0])
        progress["total_articles"] = total_articles
        progress["stopped_reason"] = "Interrupted by user or signal" if _shutdown else "Completed all pages"
        progress["stopped_at"] = datetime.datetime.now().isoformat()
        save_progress(progress)

        print()
        print(f"🎉 DONE — ITN Entertainment News")
